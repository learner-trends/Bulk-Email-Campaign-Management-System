 ...
 * Converts exceptions into standardised ApiResponse envelopes.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleInvalidCampaignState(InvalidCampaignStateException ex) {
        log.warn("Invalid campaign state: {}", ex.getMessage());
